...
const SURPRISE_CONFIG = {
    ...
    partnerName: "sibaa 💖",
    senderName: "amer ✍️",
    message: "I love you so much, ya albee. ❤️ You make every day happier. I'm so lucky to have you. Happy Birthday, my love! 🎂💖"
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    class Balloon {
        ...
        update() {
            ...
            this.currentX =
                this.x +
                Math.sin(this.time + this.swayOffset) * this.swayAmount;
        ...
        draw() {
            if (this.type === 'balloon') {
                ...
                ctx.bezierCurveTo(
                    this.currentX - 5,
                    this.y + this.radiusY + this.stringLength / 3,
                    this.currentX + 5,
                    this.y + this.radiusY + (this.stringLength / 3) * 2,
                    this.currentX,
    ...
    document.addEventListener('mousemove', (e) => {
        ...
        const rotateX =
            -(e.clientY - halfHeight) / halfHeight * 6;

        const rotateY =
            (e.clientX - halfWidth) / halfWidth * 6;
    ...
    giftBoxContainer.addEventListener('click', () => {
        ...
        const boxGlow =
            document.getElementById('boxGlow');
